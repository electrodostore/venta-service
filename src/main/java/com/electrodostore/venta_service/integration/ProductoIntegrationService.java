...
public class ProductoIntegrationService {
    ...
    @CircuitBreaker(name = "producto-service", fallbackMethod = "fallbackProductoService")
    ...
    public List<ProductoIntegrationDto> fallbackProductoService(Set<Long> productsIds, Throwable ex){
